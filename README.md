...
* What influences if the rocket will land successfully?<br>
* What is the effect of each relationship of rockets variables on outcomes? <br>
* What are the Conditions which will aid SpaceX to achieve the best results? <br>
